...
long bl_list_nth(list_t *list, long i) {
...
list_t *bl_list_new(list_t *before, list_t *after, long len, long *items) {
...
list_t *bl_list_prepend(list_t *list, long item) {
    return bl_list_new(NULL, list, list->len+1, &item);
}

list_t *bl_list_insert(list_t *list, long i, long item) {
...
list_t *bl_list_remove(list_t *list, long i) {
